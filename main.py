...
# creating a window
window = Tk()
window.title("Raihan's calculator" )
window.geometry('510x550')
# picture label
window.iconbitmap(r'img/cal.ico')
pic = PhotoImage(file='img/cal.png')
headingLabel = Label(window, image=pic)
headingLabel.pack(side=TOP, pady=10,padx=100)

# heading label
heading = Label(window, text='Lets make some calculation', font=font, underline=0)
